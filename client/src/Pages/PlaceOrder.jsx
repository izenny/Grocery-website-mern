...
import { RiShoppingCart2Line } from "react-icons/ri";
import CartProduct from "../Components/CartProduct";
import ConfirmOrder from "./ConfirmOrder"; // Make sure the path is correct
...
const PlaceOrder = () => {
  ...
  const handleSubmit = () => {
    // Do something with the order details, like sending them to the backend
      ...
      <div className="w-full h-full p-4">
        ...
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="h-full w-full md:w-2/3 p-4">
            ...
            <div className="m-2 p-2 h-full flex flex-wrap justify-center shadow">
              {["name", "mobileNumber", "email", "address", "city", "pin", "district", "state"].map((field) => (
                <div className="flex flex-col m-1" key={field}>
            ...
            <div className="m-2 flex items-center justify-center p-2 shadow">
              <label htmlFor="deliveryDate" className="mr-2">
                Date
              </label>
              <input
                type="date"
                ...
                className="border p-1"
              />
              <label htmlFor="deliveryTime" className="mr-2 ml-3">
                Time: 9am - 6pm
              </label>
            </div>
            <div className="flex justify-center items-center mt-4">
